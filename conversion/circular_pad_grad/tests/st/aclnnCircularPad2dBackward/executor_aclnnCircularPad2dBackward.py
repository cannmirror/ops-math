...
@register("ascend_method_torch_circularpad2dbackward")
class MethodTorchCircularPad2dApi(BaseApi):
    def __init__(self, task_result: TaskResult):
        super(MethodTorchCircularPad2dApi, self).__init__(task_result)
