...
@register("ascend_function_replication_pad2d_backward")
class ReplicationPad3dBackward(BaseApi):
    def __call__(self, input_data: InputDataset, with_output: bool = False):
        ...
        gradinput = torch.ops.aten.replication_pad2d_backward(gradOutput, input_self, padding)
        if (fp16 == 1):
